...
<html>
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/www/css/style_background.css">
    
    <script src=https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js></script>
    <script type="text/javascript" src="/www/js/modern.js"></script>
    <meta name="google-site-verification" content="sks6r59MbhEQtZLWoK17RE1nrcyo-VcJdd1R5gHj-Eg" /> 
  </head>
